...
def detect_thread(detect_m, im):
    return detect_m.detect(im, need_resize=True)
                ...
                with self.tlock:
                    with concurrent.futures.ThreadPoolExecutor() as executor:
                        ...
                        for nkey, network in net.items():
                            result_dict[nkey] = executor.submit(detect_thread, detect_m, frame_rgb)
